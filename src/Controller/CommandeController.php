...
class CommandeController extends AbstractController
{
    ...
    /**
     * @Route("/commande/back", name="commande_indexssss", methods={"GET"})
     */
    public function indexxxxx(CommandeRepository $commandeRepository,SessionInterface $session): Response
    {
     ...
     */
    public function new(Request $request,$idproduit,\Swift_Mailer $mailer,SessionInterface $session): Response
    {
     ...
     */
    public function paniercommande(Request $request,$idproduit,\Swift_Mailer $mailer): Response
    {
        $commande = new Commande();
        $em=$this->getDoctrine()->getManager();
        $produit=$em->getRepository(produit::class)->find($idproduit);
