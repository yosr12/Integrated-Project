 ...
 */
final class Version20210331011006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mail (id INT AUTO_INCREMENT NOT NULL, subject VARCHAR(255) NOT NULL, destinataire VARCHAR(255) NOT NULL, body VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
